...
import { INPUT_ACCEPT_ATTRIBUTE } from 'components/image-input/constants';
import { useImageInput } from 'components/image-input/hooks';
import { TImageInputProps } from 'components/image-input/types';
